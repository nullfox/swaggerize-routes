...
module.exports = function validator(options) {
    ...
    return {
        ...
        makeAllResponse: function (validators, route) {
            var keyedValidators = {};
            ...
            Object.keys(validators).forEach(function (k) {
                ...
                keyedValidators[k] = self.make(parameter, route.consumes).schema;
            });

            return keyedValidators;
        },
        ...
        make: function (parameter, consumes) {
            ...
            if (parameter.$ref) {
                parameter = utils.resolveRef(schemas, parameter.$ref);
            }
